...
#End Region
    ...
    Public Function JobSplit(ByRef preactorComObject As PreactorObj, ByRef pespComObject As Object, ByRef RecordNumber As Integer) As Integer
        ...
        If strOrderOprName.Contains("ST3") Then
            ...
            If K203_OrderSerialRecordNumber <= 0 Then
                MsgBox("No relevant record in K202_OrderSerial table ")
            End If
    ...
    Function AdjustCuringStartAndEnd2(ByRef preactorComObject As PreactorObj, ByRef pespComObject As Object) As Integer
        Dim preactor As IPreactor = PreactorFactory.CreatePreactorObject(preactorComObject)
                    ...
                    Do
                        ...
                        If partNoNew = sku Then
                            ...
                            If OpNo = 40 And OpName.Contains("CLAMP CURING") Then
                                ...
                                Dim maxMold As Integer = GetMaximumMoldNumber(connetionString, partNoNew)
    ...
    Public Function GetMaximumMoldNumber(ByRef connetionString As String, ByRef partNo As String) As Integer
        Try
            Dim connection As SqlConnection
            Dim adapter As SqlDataAdapter
            Dim command As New SqlCommand
